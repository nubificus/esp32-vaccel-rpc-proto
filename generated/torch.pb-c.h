...
typedef struct Vaccel__Torch__Tensor Vaccel__Torch__Tensor;
typedef struct Vaccel__Torch__ModelLoadRequest Vaccel__Torch__ModelLoadRequest;
typedef struct Vaccel__Torch__ModelRunRequest Vaccel__Torch__ModelRunRequest;
typedef struct Vaccel__Torch__ModelRunResponse Vaccel__Torch__ModelRunResponse;
...
struct  Vaccel__Torch__ModelLoadRequest
{
  ProtobufCMessage base;
  int64_t session_id;
  int64_t model_id;
...
struct  Vaccel__Torch__ModelRunRequest
{
  ProtobufCMessage base;
  int64_t session_id;
  int64_t model_id;
...
struct  Vaccel__Torch__ModelRunResponse
{
  ProtobufCMessage base;
